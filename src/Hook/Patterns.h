...
inline const Signature BBuildAndAsyncSendFrameSigs[] = {
    ...
    {"1779486452", "48 8B C4 55 48 8D 68 A1 48 81 EC C0 00 00 00"},  // stable
};
...
inline const Signature BuildDepotDependencySigs[] = {
    ...
    {"1779486452", "48 8B C4 4C 89 48 20 89 50 10 48 89 48 08 55 ?? 48 8D"},  // stable
};
...
inline const Signature BuildSpawnEnvBlockSigs[] = {
    ...
    {"1779486452", "48 89 5C 24 ?? 4C 89 44 24 ?? 48 89 54 24 ?? 48 89 4C 24 ?? 55 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 ?? ?? ?? ?? 48 81 EC ?? ?? ?? ?? 48 8B 05"},  // stable
};
...
inline const Signature CUtlBufferEnsureCapacitySigs[] = {
    ...
    {"1779486452", "48 89 5C 24 ?? 57 48 83 EC ?? 0F B6 41 ?? 8D 7A"},  // stable
};
...
inline const Signature CUtlMemoryGrowSigs[] = {
    ...
    {"1779486452", "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 30"},  // stable
};
...
inline const Signature CheckAppOwnershipSigs[] = {
    ...
    {"1779486452", "48 8B C4 89 50 10 55 53 48 8D 68 D8"},  // stable
};
...
inline const Signature GetAppDataFromAppInfoSigs[] = {
    ...
    {"1779486452", "48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 41 56 41 57 48 81 EC 70 01 00 00"},  // stable
};
...
inline const Signature GetAppIDForCurrentPipeSigs[] = {
    ...
    {"1779486452", "48 83 EC 08 8B 81 30 0D 00 00 4C 8B D9 44 8B 91 D8 00 00 00 83 F8 FF"},  // stable
};
...
inline const Signature IPCProcessMessageSigs[] = {
    ...
    {"1779486452", "48 89 5C 24 ?? 48 89 6C 24 ?? 56 41 54 41 55 41 56 41 57 48 83 EC ?? 49 8B D9"},  // stable
};
...
inline const Signature LoadDepotDecryptionKeySigs[] = {
    ...
    {"1779486452", "48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 48 83 EC 30 48 63 FA 49 8B E9 8B D7 49 8B D8 48 8B F1"},  // stable
};
...
inline const Signature LoadPackageSigs[] = {
    ...
    {"1779486452", "48 89 5C 24 18 48 89 6C 24 20 56 57 41 54 41 55 41 57 48 81 EC 20 01"},  // stable
};
...
inline const Signature MarkLicenseAsChangedSigs[] = {
    ...
    {"1779486452", "89 54 24 ?? 53 55 56 57 41 56 48 83 EC"},  // stable
};
...
inline const Signature OptedInMaskSigs[] = {
    ...
    {"1779486452", "89 54 24 ?? 55 53 56 41 55 41 56 41 57"},  // stable
};
...
inline const Signature PchMsgNameFromEMsgSigs[] = {
    ...
    {"1779486452", "48 89 5C 24 08 57 48 83 EC 20 8B D9 E8"},  // stable
};
...
inline const Signature ProcessPendingLicenseUpdatesSigs[] = {
    ...
    {"1779486452", "4C 8B DC 49 89 4B 08 41 55 41 57 48 83 EC 48 4C 8B E9"},  // stable
};
...
inline const Signature RecvPktSigs[] = {
    ...
    {"1779486452", "48 8B C4 55 48 8D A8 98 F6 FF FF 48 81 EC 60 0A"},  // stable
};
...
inline const Signature SpawnProcessSigs[] = {
    ...
    {"1779486452", "48 89 5C 24 18 4C 89 4C 24 20 48 89 54 24 10 55 56 57 41 54 41 55 41 56 41 57 48 8D"},  // stable
};
...
inline const Signature GetAppByIDSigs[] = {
    ...
    {"1779486452", "89 54 24 ?? 56 48 83 EC ?? 48 8B 05"},  // stable
};
...
inline const Signature LoadModuleWithPathSigs[] = {
    ...
    {"1779486452", "48 89 5C 24 18 48 89 6C 24 20 56 41 54 41 57 48 83 EC 40"},  // stable
};
...
inline const Signature TopManagerCallSigs[] = {
    ...
    {"1779486452", "83 FF 07 0F 84 ?? ?? ?? ?? E8 ?? ?? ?? ?? 45 33 C0"},  // stable
};
...
inline const Signature AddProtobufAsBinarySigs[] = {
    ...
    {"1779486452", "48 89 5C 24 ?? 48 89 6C 24 ?? 48 89 74 24 ?? 57 48 83 EC 20 48 8B 05 ?? ?? ?? ?? 48 8B F2 48 8B D9 44 8B 00"},  // stable
};
